...
public enum ErrorCode {
        ...
        HEADER_ERROR(ResponseCode.HEADER_ERROR, "Header invalid"),
        MERCHANT_PAYLOAD_NOT_FOUND(ResponseCode.MERCHANT_PAYLOAD_NOT_FOUND, "Merchant payload not found"),
        ...
        MERCHANT_ALGORITHM_NOT_SUPPORTED(ResponseCode.MERCHANT_ALGORITHM_NOT_SUPPORTED,
                        "Merchant algorithm not supported"),
