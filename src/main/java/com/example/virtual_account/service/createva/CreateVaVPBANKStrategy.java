...
@Component("VPBANK")
public class CreateVaVPBANKStrategy implements CreateVaStrategy {
    private final String prefix = "008";
    private final String redisKey = "VPBANK-LENGTH-9"; // total length = 9, prefix = 3 -> suffix length = 6
    private final int suffixLength = 6;
    private final GenVANumberService vaNumberService;
    private final VirtualAccountRepository virtualAccountRepository;

    public CreateVaVPBANKStrategy(GenVANumberService vaNumberService,
